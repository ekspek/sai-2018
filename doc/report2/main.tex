...
\begin{align*}
	\dot{h} &= V\sin\gamma \\
	\dot{x} &= V\cos\gamma \\
	\dot{V} &= \frac{1}{m}\left[T - D - mg\sin\gamma\right] \\
	\dot{\gamma} &= \frac{1}{mV}\left[L - mg\cos\gamma\right]
\end{align*}
...
\begin{align*}
	\dot{h} &= V_0 \gamma \\
	\dot{x} &= V \\
	\dot{V} &= -g\gamma + \frac{1}{m}T \\
	\dot{\gamma} &= \frac{2g}{V_0^2}V + \frac{\rho V_0SC_L}{2m}\alpha \\
\end{align*}
